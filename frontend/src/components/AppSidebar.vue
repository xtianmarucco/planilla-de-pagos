<template>
  <aside class="flex flex-col w-[240px] min-h-screen bg-white shadow-sidebar flex-shrink-0 py-6 px-4 gap-8">

    <!-- Logo -->
    <div class="flex items-center gap-3 px-2">
      <div class="w-10 h-10 bg-primary rounded-2xl flex items-center justify-center shadow-btn flex-shrink-0">
      ...
      <div>
        <p class="font-bold text-brand-text text-sm leading-tight m-0">Planilla</p>
    ...
    <nav class="flex flex-col gap-1 flex-1">
      ...
      >
        <div
          ...
          :class="isActive(item) ? 'bg-primary text-white shadow-btn' : 'bg-gray-100 text-gray-500'"
        >
