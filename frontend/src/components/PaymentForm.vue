...
const errors = reactive({
  client_id: '', payment_date: '', amount: '', payment_method: '', notes: '',
});
...
watch(
  ...
  (val) => {
    if (val) {
      ...
      form.payment_date   = val.payment_date?.slice(0, 10) ?? today;
