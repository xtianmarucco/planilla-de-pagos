  ...
  <div class="space-y-6">
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <div
            class="bg-white rounded-3xl shadow-card w-full max-w-md max-h-[90vh] overflow-y-auto"
          >
          ...
          >
            ...
            <p class="text-sm text-gray-500 leading-relaxed">
              ...
              <strong class="text-brand-text">{{
                confirmDelete.payment?.client?.name
              }}</strong>
              por
              <strong class="text-brand-text">{{
                formatCurrency(confirmDelete.payment?.amount)
              }}</strong
